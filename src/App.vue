...
<div class="app-container">
    ...
    <nav class="mui-bar mui-bar-tab">
        ...
        <router-link class="mui-tab-item-lib" to="/shopcar">
            <span class="mui-icon mui-icon-extra mui-icon-extra-cart"><span class="mui-badge" id="badge">{{ $store.getters.getAll }}</span></span>
...
.app-container {
    padding-top: 40px;
    padding-bottom: 50px;
    overflow-x: hidden; //设置动画时候处理滚动条问题
}
